(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            } else if (!e.target.closest(".menu") || e.target.closest(".menu__close")) {
    ...
    function initSliders() {
        if (document.querySelector(".programs__slider")) new swiper_core_Swiper(".programs__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".programs__arr_prev",
                nextEl: ".programs__arr_next"
            },
            on: {}
        });
        if (document.querySelector(".stages .tabs__navigation")) new swiper_core_Swiper(".stages .tabs__navigation", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".stages .tabs__arr_prev",
                nextEl: ".stages .tabs__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2
        ...
        if (document.querySelector(".articles__slider")) new swiper_core_Swiper(".articles__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".articles__arr_prev",
                nextEl: ".articles__arr_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
    ...
    document.addEventListener("click", (function(e) {
        ...
        } else if (!e.target.closest(".header__input")) html.classList.remove("search-open");
    }));
    window["FLS"] = true;
    menuInit();
    spollers();
